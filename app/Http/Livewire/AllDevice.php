...
final class AllDevice extends PowerGridComponent
{
    use ActionButton;
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Device>
     */
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('id')
            ->addColumn('title')
            ->addColumn('description_excerpt', function (Device $model) {
                return Str::words($model->description, 6);
            })
            ->addColumn('serial')
            ->addColumn('priority')
            ->addColumn('status')
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('DESCRIPTION', 'description_excerpt', 'description')
                ->sortable()
                ->editOnClick()
                ->searchable(),
